  ...
  return (
    <div className="flex flex-col w-full min-h-screen font-poppins bg-gray-100">
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="bg-custom-blue w-full h-[60vh] flex items-center justify-center text-white">
          {/* Text Section */}
          <div className="w-full max-w-screen-lg mx-auto text-center mt-16 px-4">
          ...
          <div className="w-full max-w-4xl mx-auto mt-48 px-4">
            <div className="w-full max-w-2xl mt-48 mx-auto">
        ...
        <div className="bg-gray-400 w-full h-[60vh]">
